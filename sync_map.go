...
func (e *entry) tryStore(i *interface{}) bool {
	...
	for {
		...
		// 没有抢到机会的线程 会再次 循环抢 atomic.CompareAndSwapPointer 去赋值
	}
}
...
// 躲避开所有 readonly里面 为 nil  和 expunged 的情况
